...
export default function Notifier() {
  ...
  return (
    <div className={`${isShown ? "fixed right-[5%]" : "fixed right-[-100%]"} z-40 top-[20%]  xs:w-60 xs:h-12 p-3 rounded bg-gradient-to-b from-main-color to-header-secondary-color hover:from-side-color hover:to-header-secondary-color text-header-main-color flex items-center justify-between overflow-hidden transition-all ease-in shadow-lg`}>
