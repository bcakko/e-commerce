  ...
  if("title" in detail){
    ...
    <div className="flex items-center justify-center mt-7 xs:w-full">
      {detail.backdrop_path ?
        <img src={`https://image.tmdb.org/t/p/w500${detail.backdrop_path}`} className="w-full xs:h-[400px] lg:h-[500px] object-cover brightness-50"/>    
      :
        <img src={`https://images.unsplash.com/photo-1614849286521-4c58b2f0ff15?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80`} className="w-full xs:h-[400px] lg:h-[500px] object-cover brightness-50"/>      
      }
